...
/*	[_BL] = KEYMAP(
	...
	DE_CIRC,   KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   F(1),   F(1),   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,KC_MINS,DE_ACUT, \
	KC_TAB,    KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,   F(1),   F(1),   KC_Z,   KC_U,   KC_I,   KC_O,   KC_P,  DE_UE,DE_PLUS, \
	KC_CAPS,   KC_A,   KC_S,   KC_D,   KC_F,   KC_G, KC_ESC,KC_BSPC,   KC_H,   KC_J,   KC_K,   KC_L,  DE_OE,  DE_AE,DE_HASH, \
	KC_LSFT,   KC_Z,   KC_X,   KC_C,   KC_V,   KC_B, KC_SLS,KC_DELT,   KC_N,   KC_M,KC_COMM, KC_DOT,DE_MINS,KC_RSFT,         \
	KC_LCTL,KC_LGUI,   F(1),KC_LALT,         KC_SPC,KC_HOME,KC_PGUP, KC_SPC,        KC_RALT,   F(1),   F(1), KC_APP,KC_RCTL, \
