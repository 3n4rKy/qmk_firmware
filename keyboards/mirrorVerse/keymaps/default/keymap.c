...
/*	[_BL] = KEYMAP(
    ...
    KC_GRAVE,  KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   F(1),   F(1),   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,KC_MINS,KC_EQL, \
    ...
    KC_LSFT,   KC_Z,   KC_X,   KC_C,   KC_V,   KC_B, KC_SLSH,KC_DELT,  KC_N,   KC_M,KC_COMM, KC_DOT,KC_SLSH,KC_RSFT,         \
    KC_LCTL,KC_LGUI,   F(1),   F(1),KC_LALT, KC_SPC,KC_HOME,KC_PGUP, KC_SPC,KC_RALT,   F(1),   F(1),   F(1), KC_APP,KC_RCTL, \
...
*/
    ...
    KC_ESC,   KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9, KC_F10, KC_F11, KC_F12,                 \
    KC_GRAVE,  KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   F(1),   F(1),   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,KC_MINS,KC_EQL, \
    KC_TAB,    KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,   F(1),   F(1),   KC_Y,   KC_U,   KC_UP,   KC_O,   KC_P,KC_LBRC,KC_RBRC, \
    KC_CAPS,   KC_A,   KC_S,   KC_D,   KC_F,   KC_G, KC_ESC,KC_BSPC,   KC_H,   KC_LEFT,   KC_DOWN,   KC_RIGHT,KC_SCLN,KC_QUOT,KC_BSLS, \
    KC_LSFT,   KC_Z,   KC_X,   KC_C,   KC_V,   KC_B, KC_SLSH,KC_DELT,  KC_N,   KC_M,KC_COMM, KC_DOT,KC_SLSH,KC_RSFT,         \
    KC_LCTL,KC_LGUI,   F(1),   F(1),KC_LALT, KC_SPC,KC_HOME,KC_PGUP, KC_SPC,KC_RALT,   F(1),   F(1),   F(1), KC_APP,KC_RCTL, \
                        KC_ENT, KC_END,KC_PGDN, KC_ENT),
   /*
